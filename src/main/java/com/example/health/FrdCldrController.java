...
public class FrdCldrController {
    ...
    private void boxMouseClick(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("frienddetailCalendar.fxml"));
            Parent root = loader.load();

            // 상세 일정 페이지 컨트롤러에 클릭한 날짜 정보 전달
            FrdDtilCldrController frddtilCldrController = loader.getController();
            frddtilCldrController.initData(clickyear, clickmonth, clickday);
